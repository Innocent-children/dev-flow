...
| `@imotong/create-dev-flow` | `0.1.1` | — | macOS arm64, Node.js `>=20` | Target operations require an installed Codex or DSH | [npm](https://www.npmjs.com/package/@imotong/create-dev-flow/v/0.1.1) · [create-dev-flow-v0.1.1](https://github.com/Innocent-children/dev-flow/releases/tag/create-dev-flow-v0.1.1) · registry package smoke passed |
