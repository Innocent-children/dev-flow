...
| --- | --- | --- | --- | --- | --- |
| `dev-flow-codex` | `0.7.2` | `0.6.1` | macOS arm64, Node.js `>=24` | Codex `>=0.147.0`; final Journey used `0.147.0` | [npm](https://www.npmjs.com/package/dev-flow-codex/v/0.7.2) · [codex-v0.7.2](https://github.com/Innocent-children/dev-flow/releases/tag/codex-v0.7.2) · registry lifecycle passed |
| `dev-flow-deepseek` | `0.7.1` | `0.6.0` | macOS arm64, Node.js `>=24` | DSH `>=0.1.0-rc.6`; final Journey used `0.1.0-rc.6` | [npm](https://www.npmjs.com/package/dev-flow-deepseek/v/0.7.1) · [deepseek-v0.7.1](https://github.com/Innocent-children/dev-flow/releases/tag/deepseek-v0.7.1) · native registry journey passed |
...
| `dev-flow-deepseek` | `0.7.1-beta.1` | `0.7.1-beta.1` | Publicly evaluable; not a stable support claim |
