...
| 产品 | 版本 | 状态 |
| --- | --- | --- |
| Core | `0.6.0` | 作为两个 Host package 的独立 bundled runtime |
| Codex | `0.7.1` | npm 与 `codex-v0.7.1` 已发布，macOS arm64 registry lifecycle 通过 |
| DeepSeek | `0.7.0` | npm 与 `deepseek-v0.7.0` 已发布，macOS arm64 native registry journey 通过 |
