...
| 产品 | 版本 | 状态 |
| --- | --- | --- |
| Core | `0.6.3` | 作为两个 Host package 的独立 bundled runtime |
| Codex | `0.7.4` | npm 与 `codex-v0.7.4` 已发布，macOS arm64 registry lifecycle 通过 |
| DeepSeek | `0.7.4` | npm 与 `deepseek-v0.7.4` 已发布，macOS arm64 native registry journey 通过 |
