...
| DeepSeek | DSH bundle、Skill、guard、MCP child 和 bundled Core | `0.7.2` |
...
Codex 当前版本 `0.7.3` 已发布到 npm，并使用 `codex-v0.7.3` GitHub Release。
DeepSeek 当前版本 `0.7.2` 已发布到 npm，并使用 `deepseek-v0.7.2` GitHub Release。
