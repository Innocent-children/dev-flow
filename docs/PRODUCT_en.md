...
| Codex | Codex Plugin, Skill, registration lifecycle, and bundled Core | `0.7.5` |
| DeepSeek | DSH bundle, Skill, guard, MCP child, and bundled Core | `0.7.4` |
...
The current DeepSeek version `0.7.4` is published to npm with the `deepseek-v0.7.4` GitHub Release.
