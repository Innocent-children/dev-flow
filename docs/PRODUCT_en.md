...
| Codex | Codex Plugin, Skill, registration lifecycle, and bundled Core | `0.7.2` |
| DeepSeek | DSH bundle, Skill, guard, MCP child, and bundled Core | `0.7.2` |
...
The current Codex version `0.7.2` is published to npm with the `codex-v0.7.2` GitHub Release.
The current DeepSeek version `0.7.2` is published to npm with the `deepseek-v0.7.2` GitHub Release.
