...
| `dev-flow-deepseek` | private source package; public version not selected | exact DSH `0.1.0-rc.8`, macOS arm64 | Source-local implementation through Phase 6; final native acceptance blocked; not publicly supported | `specs/010-deepseek-explicit-graph-host/` |
