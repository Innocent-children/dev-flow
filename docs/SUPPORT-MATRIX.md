...
| `dev-flow-deepseek` | private source package; public version not selected | planned DSH `0.1.0-rc.8`, macOS arm64 | Feature 010 Ready; not implemented or publicly supported | `specs/010-deepseek-explicit-graph-host/` |
