...
当前 DeepSeek 路线从已完成的图 Core 独立推进，不阻塞 Codex 发布：
...
004 的完整规划资产作为 Core Contract 0.1 历史保留。Feature 010 已从当前 `main`、Core
Contract 0.2、Schema 2 和 DSH `0.1.0-rc.8` 重新建立实施权威；不得从 004 复制旧状态机、
launcher 或发布假设。

010 完成后，通过 standalone release command 选择合格模式并公开第二个产品；不得新建发布
Feature，也不得把 DeepSeek 发布重新塞回已完成的 006 或 009。
...
- 010 独立实施，但不得从 004 覆盖当前 Core 或已发布 Codex 合同；
