...
| Codex | `0.6.0` | npm and `codex-v0.6.0` published; macOS arm64 registry lifecycle passed |
| DeepSeek | `0.6.0` | npm and `deepseek-v0.6.0` published; macOS arm64 native registry journey passed |
