...
| --- | --- |
| Package | `dev-flow-codex@0.7.2` |
| Bundled Core | `0.6.1` |
| Platform | macOS arm64 |
| Node.js | `>=24` |
| Codex | `>=0.147.0` |
| Release | [codex-v0.7.2](https://github.com/Innocent-children/dev-flow/releases/tag/codex-v0.7.2) |

The `0.7.2` normal release passed registry-package installation, package/Core identity, setup, Core
