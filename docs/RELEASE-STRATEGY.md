...
> **文档状态**：本文是 Feature 006 及相关后续 Feature 的目标发布策略，不是 Feature 002
> 已实现能力。Feature 002 已交付共享 Core Contract，但两个产品仍只是私有骨架；可分发
> Runtime、宿主安装、升级、卸载、构建资产、Tag、Release 和 npm 发布均未实现，也不会由
> 当前仓库验证执行。
