...
> **文档状态**：本文是 Feature 006 及相关后续 Feature 的目标发布策略，不是 Feature
> 001 已实现能力。Feature 001 只建立根版本源、两个私有产品骨架和无发布权限的 PR
> 验证；可分发 Runtime、宿主安装、升级、卸载、构建资产、Tag、Release 和 npm 发布
> 均未实现，也不会由当前仓库验证执行。
