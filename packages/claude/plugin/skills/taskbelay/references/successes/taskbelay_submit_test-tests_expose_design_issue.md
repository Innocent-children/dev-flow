<!-- Generated from skills/taskbelay/core/successes/taskbelay_submit_test-tests_expose_design_issue.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp taskbelay_submit_test tests_expose_design_issue -->
```json
{
...
<!-- example:mcp-success taskbelay_submit_test tests_expose_design_issue -->
```json
{
  "ok": true,
