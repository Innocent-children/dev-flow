<!-- Generated from skills/taskbelay/core/successes/taskbelay_resolve_blocker-expand_scope.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp taskbelay_resolve_blocker expand_scope -->
```json
{
...
<!-- example:mcp-success taskbelay_resolve_blocker expand_scope -->
```json
{
  "ok": true,
  ...
  "result": {
    ...
    "current_action": {
      ...
      "revision": 7,
      "submission_tool": "taskbelay_submit_tasks",
      "task_id": "task-example"
    },
    ...
    "file_scope_records": [
      {
        ...
        "applicability": "task_plan_update",
        "consumed": false,
        "created_at": "2026-09-10T00:00:00Z",
