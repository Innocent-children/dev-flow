<!-- Generated from skills/taskbelay/core/successes/taskbelay_cancel_task-cancel.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp taskbelay_cancel_task cancel -->
```json
{
  "host": "claude",
...
<!-- example:mcp-success taskbelay_cancel_task cancel -->
```json
{
  "ok": true,
  "request_id": "cancel-request-example",
