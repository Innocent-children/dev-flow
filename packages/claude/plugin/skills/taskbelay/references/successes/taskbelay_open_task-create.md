<!-- Generated from skills/taskbelay/core/successes/taskbelay_open_task-create.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp taskbelay_open_task create -->
```json
{
  "host": "claude",
  "new_task": {
...
<!-- example:mcp-success taskbelay_open_task create -->
```json
{
  "ok": true,
