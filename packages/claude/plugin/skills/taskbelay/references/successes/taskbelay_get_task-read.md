<!-- Generated from skills/taskbelay/core/successes/taskbelay_get_task-read.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp taskbelay_get_task read -->
```json
{
  "host": "claude",
...
<!-- example:mcp-success taskbelay_get_task read -->
```json
{
  "ok": true,
