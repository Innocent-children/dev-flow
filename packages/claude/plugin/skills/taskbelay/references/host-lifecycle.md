...
plugins or start a new session and review Host permissions. `taskbelay-claude remove --json` removes
...
`TASKBELAY_DATA_DIR` consistent across Claude, MCP, hooks and management commands. Do not start a
