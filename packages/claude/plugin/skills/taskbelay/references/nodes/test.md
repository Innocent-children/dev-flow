<!-- Generated from skills/taskbelay/core/nodes/test.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->

# TEST: taskbelay_submit_test
...
[Complete request, successful response and error example](test-examples.md#taskbelay_submit_test-tests_passed).
...
[Complete request, successful response and error example](test-examples.md#taskbelay_submit_test-tests_accepted_with_known_failures).
...
[Complete request, successful response and error example](test-examples.md#taskbelay_submit_test-tests_failed_implementation).
...
[Complete request, successful response and error example](test-examples.md#taskbelay_submit_test-tests_expose_design_issue).
...
[Complete request, successful response and error example](test-examples.md#taskbelay_submit_test-tests_expose_requirement_issue).
...
[Complete request, successful response and error example](test-examples.md#taskbelay_submit_test-verification_budget_increased).
