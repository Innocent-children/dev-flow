<!-- Generated from skills/taskbelay/core/nodes/tasks.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->

# TASKS: taskbelay_submit_tasks
...
node; choosing TaskBelay or a worktree is not approval of an implementation plan.
...
[Complete request, successful response and error example](tasks-examples.md#taskbelay_submit_tasks-tasks_plan_saved).
...
[Complete request, successful response and error example](tasks-examples.md#taskbelay_submit_tasks-tasks_ready).
...
[Complete request, successful response and error example](tasks-examples.md#taskbelay_submit_tasks-tasks_require_design).
...
[Complete request, successful response and error example](tasks-examples.md#taskbelay_submit_tasks-tasks_require_requirements).
