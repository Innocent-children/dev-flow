...
host-launch inspect takes request and repositories (each key and absolute repository_path). Retain the entire result as assessment.anchor. Show change_level, candidate_components, candidate_paths, public_contract_flags, persistence_or_state_flags, host_or_platform_flags, verification_shape, unknowns and reasons. Resolve material unknowns; reuse the actual user choice.
