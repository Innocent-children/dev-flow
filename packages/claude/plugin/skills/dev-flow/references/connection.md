<!-- Generated from skills/dev-flow/core/connection.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
[Complete request, successful response and error example](connection-examples.md#dev_flow_server_info-handshake).

Read `result.product`, `version`, `transport`, `health`, `supported_hosts`, `supported_processes`,
`method_profiles`, `tools`, and `host_preferences.claude.codebase_memory`. Require product `dev-flow`,
canonical version, stdio/ready, claude support, one supported `standard-development` process with a
...
[Complete request, successful response and error example](connection-examples.md#dev_flow_open_task-create).
...
[Complete request, successful response and error example](connection-examples.md#dev_flow_open_task-multiple).
...
[Complete request, successful response and error example](connection-examples.md#dev_flow_open_task-resume).
...
[Complete request, successful response and error example](connection-examples.md#dev_flow_get_task-read).
...
[Complete request, successful response and error example](connection-examples.md#dev_flow_get_next_action-guarded-read).
