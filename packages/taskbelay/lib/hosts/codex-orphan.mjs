...
export async function inspectOrphanRegistration(paths) {
  ...
  if (receipt.product?.name !== "taskbelay-codex" || !/^\d+\.\d+\.\d+$/.test(receipt.product?.version) ||
      !absolute(root) || basename(root) !== "taskbelay-codex" ||
      registration?.marketplace_name !== "taskbelay-local" || registration.marketplace_root !== root ||
      registration.plugin_name !== "taskbelay-codex" || registration.plugin_selector !== "taskbelay-codex@taskbelay-local" ||
