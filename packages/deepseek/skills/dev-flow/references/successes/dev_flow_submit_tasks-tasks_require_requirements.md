<!-- Generated from skills/dev-flow/core/successes/dev_flow_submit_tasks-tasks_require_requirements.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp dev_flow_submit_tasks tasks_require_requirements -->
```json
{
...
<!-- example:mcp-success dev_flow_submit_tasks tasks_require_requirements -->
```json
{
  "ok": true,
