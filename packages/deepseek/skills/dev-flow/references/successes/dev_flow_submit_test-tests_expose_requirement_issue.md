<!-- Generated from skills/dev-flow/core/successes/dev_flow_submit_test-tests_expose_requirement_issue.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp dev_flow_submit_test tests_expose_requirement_issue -->
```json
{
...
<!-- example:mcp-success dev_flow_submit_test tests_expose_requirement_issue -->
```json
{
  "ok": true,
