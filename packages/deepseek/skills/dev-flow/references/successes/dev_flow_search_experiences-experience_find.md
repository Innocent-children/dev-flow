<!-- Generated from skills/dev-flow/core/successes/dev_flow_search_experiences-experience_find.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->

# dev_flow_search_experiences: experience_find
...
<!-- example:resolved-mcp dev_flow_search_experiences experience_find -->
```json
{
  "host": "deepseek",
  "page": 1,
...
<!-- example:mcp-success dev_flow_search_experiences experience_find -->
```json
{
  "ok": true,
    ...
    "items": [
      {
        ...
        "task_state": "COMPREHENSION_REVIEW",
        "task_summary": "Return the requested field from the endpoint."
      }
    ],
    "page": 1
  },
