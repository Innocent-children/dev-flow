<!-- Generated from skills/dev-flow/core/successes/dev_flow_get_experiences-experience_read.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->

# dev_flow_get_experiences: experience_read
...
<!-- example:resolved-mcp dev_flow_get_experiences experience_read -->
```json
{
  "host": "deepseek",
  "page": 1,
...
<!-- example:mcp-success dev_flow_get_experiences experience_read -->
```json
{
  "ok": true,
