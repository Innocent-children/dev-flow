<!-- Generated from skills/dev-flow/core/successes/dev_flow_resolve_blocker-verification-or-recovery.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp dev_flow_resolve_blocker verification-or-recovery -->
```json
{
...
<!-- example:mcp-success dev_flow_resolve_blocker verification-or-recovery -->
```json
{
  "ok": true,
