<!-- Generated from skills/dev-flow/core/successes/dev_flow_submit_design-design_requires_requirements.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp dev_flow_submit_design design_requires_requirements -->
```json
{
...
<!-- example:mcp-success dev_flow_submit_design design_requires_requirements -->
```json
{
  "ok": true,
