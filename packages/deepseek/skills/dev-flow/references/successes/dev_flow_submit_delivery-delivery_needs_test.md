<!-- Generated from skills/dev-flow/core/successes/dev_flow_submit_delivery-delivery_needs_test.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->

# dev_flow_submit_delivery: delivery_needs_test
...
<!-- example:resolved-mcp dev_flow_submit_delivery delivery_needs_test -->
```json
{
...
<!-- example:mcp-success dev_flow_submit_delivery delivery_needs_test -->
```json
{
  "ok": true,
