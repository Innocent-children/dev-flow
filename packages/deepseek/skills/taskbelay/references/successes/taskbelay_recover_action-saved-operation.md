<!-- Generated from skills/taskbelay/core/successes/taskbelay_recover_action-saved-operation.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp taskbelay_recover_action saved-operation -->
```json
{
...
<!-- example:mcp-success taskbelay_recover_action saved-operation -->
```json
{
  "ok": true,
  ...
  "result": {
    ...
    "last_operation": {
      ...
      "from_revision": 1,
      "kind": "apply_action",
      "operation_id": "setup-1-requirements_ready",
