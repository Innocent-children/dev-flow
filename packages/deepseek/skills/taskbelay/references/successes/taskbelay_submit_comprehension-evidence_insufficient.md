<!-- Generated from skills/taskbelay/core/successes/taskbelay_submit_comprehension-evidence_insufficient.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp taskbelay_submit_comprehension evidence_insufficient -->
```json
{
...
<!-- example:mcp-success taskbelay_submit_comprehension evidence_insufficient -->
```json
{
  "ok": true,
