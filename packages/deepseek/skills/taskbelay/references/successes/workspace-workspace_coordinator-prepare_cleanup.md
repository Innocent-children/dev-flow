...
```json
{
  ...
  "relaunch": {
    "arguments": [
      "--profile",
      "web",
      "/taskbelay resume-cleanup launch=00000000-0000-4000-8000-000000000001 repository=primary task=task-example revision=9\nThe receipt-owned source checkout is now the fixed DSH Workspace Root.\nAsk the developer to send exactly: /taskbelay cleanup-worktree launch=00000000-0000-4000-8000-000000000001 repository=primary task=task-example revision=9\nDo not delete the worktree or branch in this relaunch turn."
    ],
    "command": "dsh",
    "cwd": "/work/project"
  },
