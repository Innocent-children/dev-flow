...
```json
{
  ...
  "relaunch": {
    "arguments": [
      "--profile",
      "web",
      "/taskbelay resume-worktree launch=00000000-0000-4000-8000-000000000001\nContinue the confirmed request exactly as assessed:\nReturn the requested endpoint field and preserve the confirmed local content."
    ],
    "command": "dsh",
    "cwd": "/example/.taskbelay-worktrees/00000000-0000-4000-8000-000000000001/primary"
  },
  ...
  "workspace_root": "/example/.taskbelay-worktrees/00000000-0000-4000-8000-000000000001/primary"
}
```
