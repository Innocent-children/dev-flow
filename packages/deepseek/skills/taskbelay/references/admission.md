...
```json
{"change_level":"standard","observed_repositories":["/work/project"],"candidate_components":["endpoint"],"candidate_paths":["src/endpoint.js"],"public_contract_flags":["Response field change"],"persistence_or_state_flags":[],"host_or_platform_flags":[],"verification_shape":["Targeted endpoint check"],"unknowns":[],"recommendation":"taskbelay","reasons":["The response is a public contract."]}
```
...
TaskBelay there is no Core/coordinator call, file edit, test/build, dependency installation, Git write
or launch receipt. A direct choice exits TaskBelay without its state or provisioning.
...
After the user chooses TaskBelay, default to `workspace_mode:"new_branch"`: create a task branch
...
```json
{"status":"relaunch_required","launch_id":"11111111-1111-4111-8111-111111111111","request_digest":"<returned digest>","workspace_root":"/work/.taskbelay-worktrees/11111111-1111-4111-8111-111111111111/primary","source_dirty_paths":{"primary":["notes/change.md"]},"source_dirty_paths_truncated":{"primary":false},"relaunch":{"command":"dsh","arguments":["--profile","web","<complete returned resume-worktree prompt>"],"cwd":"/work/.taskbelay-worktrees/11111111-1111-4111-8111-111111111111/primary"}}
```
...
The Core calls require `/taskbelay` in the current direct user turn. An existing Task resume does not
...
```text
/taskbelay resume-worktree launch=11111111-1111-4111-8111-111111111111
```
...
```text
tool: mcp__taskbelay__taskbelay_open_task
