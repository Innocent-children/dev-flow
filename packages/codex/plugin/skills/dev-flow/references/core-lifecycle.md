<!-- Generated from skills/dev-flow/core/core-lifecycle.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
[Complete request, successful response and error example](core-lifecycle-examples.md#dev_flow_prepare_task_relocation-prepare).
...
[Complete request, successful response and error example](core-lifecycle-examples.md#dev_flow_resolve_blocker-relocation).
...
[Complete request, successful response and error example](core-lifecycle-examples.md#dev_flow_cancel_task-cancel).
...
[Complete request, successful response and error example](core-lifecycle-examples.md#dev_flow_abandon_task-abandon).
