...
[Complete request, successful response and error example](delivery-examples.md#dev_flow_submit_delivery-delivery_complete).
...
[Complete request, successful response and error example](delivery-examples.md#dev_flow_submit_delivery-delivery_needs_implementation).
...
[Complete request, successful response and error example](delivery-examples.md#dev_flow_submit_delivery-delivery_needs_test).
...
[Complete request, successful response and error example](delivery-examples.md#dev_flow_submit_delivery-delivery_needs_comprehension).
...
[Complete request, successful response and error example](delivery-examples.md#dev_flow_submit_delivery-delivery_needs_design).
...
[Complete request, successful response and error example](delivery-examples.md#dev_flow_submit_delivery-delivery_needs_requirements).
