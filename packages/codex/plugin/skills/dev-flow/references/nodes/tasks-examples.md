<!-- Generated from skills/dev-flow/core/nodes/tasks-examples.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
Complete successful request and response: [view every returned field](../successes/dev_flow_submit_tasks-tasks_plan_saved.md).
...
<!-- example:mcp-output dev_flow_submit_tasks tasks_plan_saved-error -->
```json
{
  "ok": false,
...
## dev_flow_submit_tasks-tasks_ready
...
Complete successful request and response: [view every returned field](../successes/dev_flow_submit_tasks-tasks_ready.md).
...
<!-- example:mcp-output dev_flow_submit_tasks tasks_ready-error -->
```json
{
  "ok": false,
  "request_id": "request-error-example",
...
## dev_flow_submit_tasks-tasks_require_design
...
Complete successful request and response: [view every returned field](../successes/dev_flow_submit_tasks-tasks_require_design.md).
...
<!-- example:mcp-output dev_flow_submit_tasks tasks_require_design-error -->
```json
{
  "ok": false,
  "request_id": "request-error-example",
...
## dev_flow_submit_tasks-tasks_require_requirements
...
Complete successful request and response: [view every returned field](../successes/dev_flow_submit_tasks-tasks_require_requirements.md).
...
<!-- error-case: {"operation":"set","path":"node_result.findings","value":[]} -->
<!-- example:mcp-output dev_flow_submit_tasks tasks_require_requirements-error -->
```json
{
  "ok": false,
  "request_id": "request-error-example",
