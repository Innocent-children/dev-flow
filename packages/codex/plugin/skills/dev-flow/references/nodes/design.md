...
[Complete request, successful response and error example](design-examples.md#dev_flow_submit_design-design_ready).
...
[Complete request, successful response and error example](design-examples.md#dev_flow_submit_design-design_requires_requirements).
