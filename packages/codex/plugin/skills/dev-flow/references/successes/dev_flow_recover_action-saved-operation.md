<!-- Generated from skills/dev-flow/core/successes/dev_flow_recover_action-saved-operation.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp dev_flow_recover_action saved-operation -->
```json
{
...
<!-- example:mcp-success dev_flow_recover_action saved-operation -->
```json
{
  "ok": true,
