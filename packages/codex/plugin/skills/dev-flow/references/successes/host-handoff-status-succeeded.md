...
<!-- example:resolved-host handoff-status succeeded -->
```json
{
...
<!-- example:host-success handoff-status succeeded -->
```json
{
  "changed": true,
  "receipt": {
    ...
    "operation_status": {
      ...
      "host_operation_id": "host-operation-example",
      "host_operation_revision": 3,
      "host_request": null,
      "host_thread_id": null,
      "phase": "handoff_succeeded",
