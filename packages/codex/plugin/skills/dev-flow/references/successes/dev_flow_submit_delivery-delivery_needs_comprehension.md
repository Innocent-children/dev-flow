<!-- Generated from skills/dev-flow/core/successes/dev_flow_submit_delivery-delivery_needs_comprehension.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->

# dev_flow_submit_delivery: delivery_needs_comprehension
...
<!-- example:resolved-mcp dev_flow_submit_delivery delivery_needs_comprehension -->
```json
{
...
<!-- example:mcp-success dev_flow_submit_delivery delivery_needs_comprehension -->
```json
{
  "ok": true,
