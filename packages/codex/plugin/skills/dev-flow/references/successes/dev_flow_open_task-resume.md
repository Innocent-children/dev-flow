<!-- Generated from skills/dev-flow/core/successes/dev_flow_open_task-resume.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp dev_flow_open_task resume -->
```json
{
  "host": "codex",
...
<!-- example:mcp-success dev_flow_open_task resume -->
```json
{
  "ok": true,
