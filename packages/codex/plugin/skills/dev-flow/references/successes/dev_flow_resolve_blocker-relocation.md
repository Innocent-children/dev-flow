<!-- Generated from skills/dev-flow/core/successes/dev_flow_resolve_blocker-relocation.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->

# dev_flow_resolve_blocker: relocation
...
<!-- example:resolved-mcp dev_flow_resolve_blocker relocation -->
```json
{
...
<!-- example:mcp-success dev_flow_resolve_blocker relocation -->
```json
{
  "ok": true,
