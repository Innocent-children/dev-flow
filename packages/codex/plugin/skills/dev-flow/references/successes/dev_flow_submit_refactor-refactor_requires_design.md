<!-- Generated from skills/dev-flow/core/successes/dev_flow_submit_refactor-refactor_requires_design.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp dev_flow_submit_refactor refactor_requires_design -->
```json
{
...
<!-- example:mcp-success dev_flow_submit_refactor refactor_requires_design -->
```json
{
  "ok": true,
