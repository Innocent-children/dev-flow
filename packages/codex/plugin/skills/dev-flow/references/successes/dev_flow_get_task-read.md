<!-- Generated from skills/dev-flow/core/successes/dev_flow_get_task-read.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp dev_flow_get_task read -->
```json
{
  "host": "codex",
...
<!-- example:mcp-success dev_flow_get_task read -->
```json
{
  "ok": true,
