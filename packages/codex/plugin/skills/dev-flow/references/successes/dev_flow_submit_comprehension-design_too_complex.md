<!-- Generated from skills/dev-flow/core/successes/dev_flow_submit_comprehension-design_too_complex.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp dev_flow_submit_comprehension design_too_complex -->
```json
{
...
<!-- example:mcp-success dev_flow_submit_comprehension design_too_complex -->
```json
{
  "ok": true,
