...
{
  "host_request": {
    "followUpPrompt": "Resume Dev Flow relocation relocation-example; inspect the Host result, then resolve the Core blocker with the exact destination repository paths.",
