<!-- Generated from skills/dev-flow/core/successes/dev_flow_submit_test-tests_accepted_with_known_failures.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp dev_flow_submit_test tests_accepted_with_known_failures -->
```json
{
...
<!-- example:mcp-success dev_flow_submit_test tests_accepted_with_known_failures -->
```json
{
  "ok": true,
