<!-- Generated from skills/taskbelay/core/successes/taskbelay_get_next_action-guarded-read.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp taskbelay_get_next_action guarded-read -->
```json
{
  "host": "codex",
...
<!-- example:mcp-success taskbelay_get_next_action guarded-read -->
```json
{
  "ok": true,
