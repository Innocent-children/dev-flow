<!-- Generated from skills/taskbelay/core/successes/taskbelay_submit_implementation-implementation_requires_design.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp taskbelay_submit_implementation implementation_requires_design -->
```json
{
...
<!-- example:mcp-success taskbelay_submit_implementation implementation_requires_design -->
```json
{
  "ok": true,
  ...
  "result": {
    ...
    "current_action": {
      ...
      "revision": 6,
      "submission_tool": "taskbelay_submit_design",
      "task_id": "task-example"
    },
