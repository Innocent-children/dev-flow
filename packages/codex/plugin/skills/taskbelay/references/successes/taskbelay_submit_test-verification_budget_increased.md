<!-- Generated from skills/taskbelay/core/successes/taskbelay_submit_test-verification_budget_increased.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp taskbelay_submit_test verification_budget_increased -->
```json
{
...
<!-- example:mcp-success taskbelay_submit_test verification_budget_increased -->
```json
{
  "ok": true,
