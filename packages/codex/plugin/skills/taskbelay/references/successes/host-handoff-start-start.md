...
<!-- example:resolved-host handoff-start start -->
```json
{
...
<!-- example:host-success handoff-start start -->
```json
{
  "host_request": {
    "followUpPrompt": "Resume TaskBelay relocation relocation-example; inspect the Host result, then resolve the Core blocker with the exact destination repository paths.",
