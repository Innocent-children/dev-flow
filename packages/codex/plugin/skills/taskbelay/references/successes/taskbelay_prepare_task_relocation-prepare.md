<!-- Generated from skills/taskbelay/core/successes/taskbelay_prepare_task_relocation-prepare.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp taskbelay_prepare_task_relocation prepare -->
```json
{
  "host": "codex",
  "revision": 1,
...
<!-- example:mcp-success taskbelay_prepare_task_relocation prepare -->
```json
{
  "ok": true,
  ...
  "result": {
    ...
    "task": {
      ...
      "current_action": {
        ...
        "revision": 2,
        "submission_tool": "taskbelay_resolve_blocker",
        "task_id": "task-example"
      },
