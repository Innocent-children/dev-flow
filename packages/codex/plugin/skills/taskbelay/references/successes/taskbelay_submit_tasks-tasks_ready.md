<!-- Generated from skills/taskbelay/core/successes/taskbelay_submit_tasks-tasks_ready.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp taskbelay_submit_tasks tasks_ready -->
```json
{
...
<!-- example:mcp-success taskbelay_submit_tasks tasks_ready -->
```json
{
  "ok": true,
