<!-- Generated from skills/taskbelay/core/nodes/comprehension.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->

# COMPREHENSION_REVIEW: taskbelay_submit_comprehension
...
[Complete request, successful response and error example](comprehension-examples.md#taskbelay_submit_comprehension-comprehension_passed).
...
[Complete request, successful response and error example](comprehension-examples.md#taskbelay_submit_comprehension-implementation_defect).
...
[Complete request, successful response and error example](comprehension-examples.md#taskbelay_submit_comprehension-code_too_complex).
...
[Complete request, successful response and error example](comprehension-examples.md#taskbelay_submit_comprehension-design_too_complex).
...
[Complete request, successful response and error example](comprehension-examples.md#taskbelay_submit_comprehension-evidence_insufficient).
...
[Complete request, successful response and error example](comprehension-examples.md#taskbelay_submit_comprehension-requirement_unclear).
