<!-- Generated from skills/taskbelay/core/nodes/refactor-examples.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
## taskbelay_submit_refactor-refactor_ready_for_test

<!-- example:mcp taskbelay_submit_refactor refactor_ready_for_test -->
```json
{
  "host": "codex",
...
Complete successful request and response: [view every returned field](../successes/taskbelay_submit_refactor-refactor_ready_for_test.md).
...
<!-- example:mcp-output taskbelay_submit_refactor refactor_ready_for_test-error -->
```json
{
  "ok": false,
  "request_id": "request-error-example",
  "tool": "taskbelay_submit_refactor",
  "error": {
...
## taskbelay_submit_refactor-refactor_requires_design

<!-- example:mcp taskbelay_submit_refactor refactor_requires_design -->
```json
{
  "host": "codex",
  "task_id": "task-example",
...
Complete successful request and response: [view every returned field](../successes/taskbelay_submit_refactor-refactor_requires_design.md).
...
<!-- example:mcp-output taskbelay_submit_refactor refactor_requires_design-error -->
```json
{
  "ok": false,
  "request_id": "request-error-example",
...
## taskbelay_submit_refactor-refactor_requires_requirements

<!-- example:mcp taskbelay_submit_refactor refactor_requires_requirements -->
```json
{
  "host": "codex",
  "task_id": "task-example",
...
Complete successful request and response: [view every returned field](../successes/taskbelay_submit_refactor-refactor_requires_requirements.md).
...
<!-- error-case: {"operation":"set","path":"node_result.findings","value":[]} -->
<!-- example:mcp-output taskbelay_submit_refactor refactor_requires_requirements-error -->
```json
{
  "ok": false,
  "request_id": "request-error-example",
