  ...
  return (
    <div className="page-stack">
      ...
      <form key={query.toString()} className="filter-panel" onSubmit={submit} aria-label={t("list.filtersAria")}>
        ...
        <label className="filter-host">{t("list.host")}<SelectField name="host" ariaLabel={t("list.host")} defaultValue={query.get("host") ?? ""} options={[{ value: "", label: t("list.allHosts") }, { value: "codex", label: "Codex" }, { value: "deepseek", label: "DeepSeek" }, { value: "claude", label: "Claude Code" }]} /></label>
