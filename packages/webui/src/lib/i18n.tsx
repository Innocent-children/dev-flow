...
const en = {
  ...
  "dashboard.recentTitle": "Latest revisions", "dashboard.emptyTitle": "No tasks yet", "dashboard.emptyDetail": "Tasks created in Codex, DeepSeek, or Claude Code appear here.",
  "list.eyebrow": "Task center", "list.title": "Tasks", "list.lede": "Review and filter Tasks created in Codex, DeepSeek, or Claude Code.",
