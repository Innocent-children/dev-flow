...
const en = {
  "experience.searchLabel": "Search experiences",
  "experience.title": "Task experiences",
  "experience.find": "Find experiences",
  "experience.context": "Understand why this change was made and what to check next time. Historical notes do not replace current verification or your understanding confirmation.",
  "experience.export": "Export Markdown",
  "experience.exporting": "Exporting…",
  "experience.exportFailed": "Export failed. Saved experience is intact; use Export Markdown to retry.",
  "experience.pendingExport": "Changes are waiting to be exported.",
  "experience.exported": "Export is up to date.",
  "experience.empty": "No experiences recorded. Mechanical changes may not need any.",
  "experience.pending": "Pending verification",
  "experience.supported": "Supported by evidence",
  "experience.refuted": "Refuted",
  "experience.problem": "Problem",
  "experience.cause": "Cause",
  "experience.resolution": "How it was handled",
  "experience.basis": "Why this conclusion",
  "experience.applicability": "When it applies",
  "experience.next_checks": "What to check next time",
  "experience.references": "References and context",
  "experience.recordedContent": "Recorded content digest",
  "experience.notes": "Your supplements",
  "experience.noNotes": "No user supplements yet.",
  "experience.addNote": "Add your understanding or a question",
  "experience.saving": "Saving…",
  "experience.saveNote": "Save supplement",
  "experience.retryNote": "Retry saved request",
  "experience.history": "Revision history",
  "experience.findHelp": "Look up reasoning from previous tasks, including archived tasks. Select a project from an experience or enter its repository path or group ID.",
  "experience.searchHint": "Problem, cause, decision, user supplement…",
  "experience.projectHint": "Repository path or group ID",
  ...
  "detail.commandLimit": "{count} automatic commands", "detail.fullSuiteAllowed": "Full suite allowed", "detail.manualHandoffAllowed": "Pending manual checks allowed",
  ...
  "verification.acceptedFailures": "Accepted with {count} known failed checks",
  ...
  "verification.eyebrow": "Verification plan", "verification.title": "Current verification effort", "verification.pendingTitle": "Verification is not planned yet", "verification.pendingBody": "The Host sets the initial plan after requirements, design, impact, work breakdown, and existing tests have been analyzed.",
  "verification.notPlanned": "Set after task analysis", "verification.commandUsage": "{used} / {count} automatic commands", "verification.initialBudget": "Initial automatic commands", "verification.fullSuites": "Full suites run", "verification.fullSuiteExpected": "Full suite initially expected", "verification.testCodeExpected": "Test-code changes initially expected", "verification.yes": "Yes", "verification.no": "No", "verification.plannedChecks": "Planned checks and reasons", "verification.adjustments": "Budget increases", "verification.noAdjustments": "No budget increase has been recorded.", "verification.adjustmentSummary": "Plan {plan}, increase {revision}: +{count}, total {total} automatic commands",
  ...
  "workspace.mode.new_branch": "New branch in current directory", "workspace.mode.current_branch": "Current branch", "workspace.mode.dedicated_worktree": "Dedicated worktree", "workspace.localBranchNote": "This Task shares the existing directory. All local edits are observed; keep the Task branch checked out.", "workspace.localCleanupBody": "The local directory, branch and uncommitted changes are retained. Completing or cancelling releases the Task claim; commit and push remain separate actions.",
  "workspace.eyebrow": "Task workspace", "workspace.title": "Working directory", "workspace.provisioning": "Provisioning", "workspace.provisioningLastKnown": "Last known", "workspace.provisioningLastKnownDetail": "This panel shows the latest workspace observation retained by Core; WebUI does not probe Git.", "workspace.provisioningUnavailable": "Unavailable", "workspace.provisioningUnavailableDetail": "Core recorded that the original worktree instance was unavailable when this Task was abandoned.", "workspace.origin": "Origin", "workspace.observation": "Current observation", "workspace.local": "Local", "workspace.remoteBase": "Source / base", "workspace.baseCommit": "Frozen base commit", "workspace.taskBranch": "Task branch / current HEAD", "workspace.receipt": "Provisioning receipt", "workspace.history": "History relation", "workspace.content": "Content digest", "workspace.currentSurface": "Current Task surface", "workspace.clean": "No current changed paths", "workspace.changed": "{count} current changed paths", "workspace.historyConflict": "Workspace history requires review before continuing.", "workspace.relocationPending": "Relocation {id} is pending; Core still retains the source claim.", "workspace.cleanupTitle": "Terminal workspace choices", "workspace.cleanupBody": "Core never deletes a worktree or branch. Keep, review, handoff, worktree removal, and branch removal stay separate Host actions with separate confirmation.",
  ...
  "recovery.body": "Core checks the saved operation for this Action before another write.",
...
const zh: Messages = {
  "experience.searchLabel": "搜索经验",
  "experience.title": "任务经验",
  "experience.find": "查找经验",
  "experience.context": "理解为什么这样修改，以及下次先检查什么。历史经验不能替代当前验证或你的理解确认。",
  "experience.export": "导出 Markdown",
  "experience.exporting": "正在导出…",
  "experience.exportFailed": "导出失败，经验数据已保留。点击“导出 Markdown”重试。",
  "experience.pendingExport": "有新的内容待导出。",
  "experience.exported": "导出内容已是最新。",
  "experience.empty": "尚未记录经验，机械修改可以没有经验。",
  "experience.pending": "待验证",
  "experience.supported": "已有依据支持",
  "experience.refuted": "已被推翻",
  "experience.problem": "遇到的问题",
  "experience.cause": "发生原因",
  "experience.resolution": "如何处理",
  "experience.basis": "判断依据",
  "experience.applicability": "适用条件",
  "experience.next_checks": "下次先检查什么",
  "experience.references": "引用与背景",
  "experience.recordedContent": "记录时的内容摘要",
  "experience.notes": "用户补充",
  "experience.noNotes": "尚无用户补充。",
  "experience.addNote": "补充你的理解或疑问",
  "experience.saving": "正在保存…",
  "experience.saveNote": "保存补充",
  "experience.retryNote": "重试原请求",
  "experience.history": "修订历史",
  "experience.findHelp": "查阅历史任务的判断过程，包括已归档任务。可点击经验中的项目筛选，也可输入仓库路径或项目标识。",
  "experience.searchHint": "问题、原因、方案、用户补充…",
  "experience.projectHint": "仓库路径或项目标识",
  ...
  "workspace.mode.new_branch":"当前目录的新分支","workspace.mode.current_branch":"当前分支","workspace.mode.dedicated_worktree":"独立工作树","workspace.localBranchNote":"任务使用原有目录，所有本地编辑都会被观察；请保持任务分支。","workspace.localCleanupBody":"保留本地目录、分支和未提交修改。完成或取消只释放任务占用，提交和推送由用户另行决定。",
  "workspace.eyebrow":"任务工作区","workspace.title":"工作目录","workspace.provisioning":"创建状态","workspace.provisioningLastKnown":"最后一次已知状态","workspace.provisioningLastKnownDetail":"这里显示 Core 最近一次保存的工作区观察；WebUI 不会直接检查 Git。","workspace.provisioningUnavailable":"工作树不可用","workspace.provisioningUnavailableDetail":"放弃这个 Task 时，Core 已确认原工作树实例不可用。","workspace.origin":"创建来源","workspace.observation":"当前观察","workspace.local":"本地","workspace.remoteBase":"来源 / 起始分支","workspace.baseCommit":"冻结的基础 commit","workspace.taskBranch":"任务分支 / 当前 HEAD","workspace.receipt":"创建 receipt","workspace.history":"历史关系","workspace.content":"内容摘要","workspace.currentSurface":"当前 Task surface","workspace.clean":"当前没有修改路径","workspace.changed":"当前有 {count} 个修改路径","workspace.historyConflict":"工作树历史需要确认后才能继续。","workspace.relocationPending":"迁移 {id} 正在等待；Core 仍保留源工作树 claim。","workspace.cleanupTitle":"终态工作树选择","workspace.cleanupBody":"Core 不删除工作树或分支。保留、检查、handoff、删除工作树和删除分支都是 Host 的独立动作，并分别确认。",
