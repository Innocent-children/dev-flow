...
const en = {
  ...
  "shell.dashboardAria": "TaskBelay dashboard", "shell.subtitle": "Control Center", "shell.navAria": "Primary navigation",
  ...
  "dashboard.recentTitle": "Latest revisions", "dashboard.emptyTitle": "No tasks yet", "dashboard.emptyDetail": "Tasks created in Codex, DeepSeek, Claude Code, or ZCode appear here.",
  "list.eyebrow": "Task center", "list.title": "Tasks", "list.lede": "Review and filter Tasks created in Codex, DeepSeek, Claude Code, or ZCode.",
  ...
  "open.resumeOnlyLede": "Resume a Task from the exact worktree instance it already owns.", "open.createInHost": "Start new Tasks in Codex, DeepSeek, Claude Code, or ZCode.", "open.createInHostDetail": "The Host assesses the request, confirms branches and working directories, and prepares every selected repository before creating the Task. Use this page to resume an existing Task.", "open.worktreePath": "Original Task worktree path", "open.resumeInstanceHint": "A recreated directory or same-named branch is not the original worktree instance.",
  ...
  "system.runtime": "Local service", "system.unavailable": "Unavailable", "system.returnShell": "Run taskbelay webui status in the shell.",
...
const storageKey = "taskbelay-language";
