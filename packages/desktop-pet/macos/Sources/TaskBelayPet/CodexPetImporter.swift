...
/// Converts local Codex artwork to TaskBelay frames at import time.
/// Runtime task semantics and playback use the common TaskBelay catalog.
enum CodexPetImporter {
    ...
    /// Atlas limits cover standard Codex sheets and TaskBelay's high-resolution extension.
    ...
    static func convert(_ data: Data, from source: URL, into destination: URL) throws -> PetAppearance {
        ...
        // Eight columns and the Codex cell ratio also define TaskBelay's scaled atlas layout.
        let columns = 8
