...
final class PetAppearanceTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        temporary = FileManager.default.temporaryDirectory.appendingPathComponent("taskbelay-appearance-\(UUID())")
    ...
    func testProvidedCodexPack() throws {
        guard let path = ProcessInfo.processInfo.environment["TASKBELAY_PET_TEST_FIXTURE"] else {
            throw XCTSkip("Set TASKBELAY_PET_TEST_FIXTURE to check a local Codex pack")
        }
