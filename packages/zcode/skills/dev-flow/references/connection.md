...
`method_profiles`, `tools`, and `host_preferences.zcode.codebase_memory`. Require product `dev-flow`,
canonical version, stdio/ready, zcode support, one supported `standard-development` process with a
