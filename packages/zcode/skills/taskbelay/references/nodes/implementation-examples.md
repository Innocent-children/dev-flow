<!-- Generated from skills/taskbelay/core/nodes/implementation-examples.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->

# IMPLEMENTATION submission examples

Read [implementation instructions](implementation.md) and use only the example for the transition returned by Core.
...
## taskbelay_submit_implementation-implementation_ready_for_test

<!-- example:mcp taskbelay_submit_implementation implementation_ready_for_test -->
```json
{
  "host": "zcode",
...
Complete successful request and response: [view every returned field](../successes/taskbelay_submit_implementation-implementation_ready_for_test.md).
...
<!-- example:mcp-output taskbelay_submit_implementation implementation_ready_for_test-error -->
```json
{
  "ok": false,
  "request_id": "request-error-example",
  "tool": "taskbelay_submit_implementation",
  "error": {
    "code": "INVALID_ARGUMENT",
    "message": "node_result.completed_work_item_ids: the closed contract requires this member",
    "details": [
      {
...
## taskbelay_submit_implementation-implementation_requires_design

<!-- example:mcp taskbelay_submit_implementation implementation_requires_design -->
```json
{
  "host": "zcode",
  "task_id": "task-example",
...
Complete successful request and response: [view every returned field](../successes/taskbelay_submit_implementation-implementation_requires_design.md).
...
<!-- example:mcp-output taskbelay_submit_implementation implementation_requires_design-error -->
```json
{
  "ok": false,
  "request_id": "request-error-example",
...
## taskbelay_submit_implementation-implementation_requires_requirements

<!-- example:mcp taskbelay_submit_implementation implementation_requires_requirements -->
```json
{
  "host": "zcode",
  "task_id": "task-example",
...
Complete successful request and response: [view every returned field](../successes/taskbelay_submit_implementation-implementation_requires_requirements.md).
...
<!-- error-case: {"operation":"set","path":"node_result.findings","value":[]} -->
<!-- example:mcp-output taskbelay_submit_implementation implementation_requires_requirements-error -->
```json
{
  "ok": false,
  "request_id": "request-error-example",
...
## taskbelay_submit_implementation-implementation_needs_refactor

<!-- example:mcp taskbelay_submit_implementation implementation_needs_refactor -->
```json
{
  "host": "zcode",
  "task_id": "task-example",
...
Complete successful request and response: [view every returned field](../successes/taskbelay_submit_implementation-implementation_needs_refactor.md).
...
<!-- error-case: {"operation":"set","path":"node_result.findings","value":[]} -->
<!-- example:mcp-output taskbelay_submit_implementation implementation_needs_refactor-error -->
```json
{
  "ok": false,
  "request_id": "request-error-example",
