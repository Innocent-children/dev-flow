<!-- Generated from skills/taskbelay/core/successes/taskbelay_submit_test-tests_passed.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp taskbelay_submit_test tests_passed -->
```json
{
...
<!-- example:mcp-success taskbelay_submit_test tests_passed -->
```json
{
  "ok": true,
