<!-- Generated from skills/taskbelay/core/successes/taskbelay_resolve_blocker-verification-or-recovery.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp taskbelay_resolve_blocker verification-or-recovery -->
```json
{
...
<!-- example:mcp-success taskbelay_resolve_blocker verification-or-recovery -->
```json
{
  "ok": true,
  ...
  "result": {
    ...
    "evidence": [
      ...
      },
      {
        "command_count": 1,
        "digest": "6dc284a687f30b2f5a0531ee9795ec36d5dc931b5c4a20a994269f84a2fbddf7",
        "evidence_id": "evidence-generated-3",
        "full_suite": false,
        "full_suite_reason": "",
        "name": "endpoint-check",
        "recorded_at": "2026-09-10T00:00:00Z",
