<!-- Generated from skills/taskbelay/core/successes/taskbelay_resolve_blocker-history.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp taskbelay_resolve_blocker history -->
```json
{
...
<!-- example:mcp-success taskbelay_resolve_blocker history -->
```json
{
  "ok": true,
