<!-- Generated from skills/taskbelay/core/successes/taskbelay_resolve_blocker-allow_once.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp taskbelay_resolve_blocker allow_once -->
```json
{
...
<!-- example:mcp-success taskbelay_resolve_blocker allow_once -->
```json
{
  "ok": true,
  ...
  "result": {
    ...
    "file_scope_records": [
      {
        "accepted_path_states": null,
        "allowed_action_id": "action-generated-1",
        "applicability": "exact_write",
        "consumed": false,
        "created_at": "2026-09-10T00:00:00Z",
        "decided_at": "2026-09-10T00:00:00Z",
        "decision": "allow_once",
        "intent_digest": "dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd",
        "observed": false,
        "paths": [
          "src/extra.js"
        ],
        "reason": "The user allows this exact prepared write.",
        "request_id": "scope-generated-1",
        "source_action_id": "action-generated-2",
