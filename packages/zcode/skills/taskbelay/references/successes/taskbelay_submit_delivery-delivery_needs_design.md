<!-- Generated from skills/taskbelay/core/successes/taskbelay_submit_delivery-delivery_needs_design.md; edit the shared source and run node scripts/sync-skill-references.mjs. -->
...
<!-- example:resolved-mcp taskbelay_submit_delivery delivery_needs_design -->
```json
{
...
<!-- example:mcp-success taskbelay_submit_delivery delivery_needs_design -->
```json
{
  "ok": true,
