...
本機寵物套件內建鯨魚娘（`whale-girl 3`），保留九類動作、57 幀和 1536×1664 單幀解析度；安裝後可從形象選單直接選取。
...
形象支援靜態 PNG、原生動畫套件及 Codex 標準格式 1/2 圖集。原生套件需提供五類任務動作，可增加四類附加動作；Codex 圖集固定擷取九類、57 幀。Dev Flow 高解析度擴充格式若要用於 Codex，須另備標準尺寸圖集。可用素材決定待機散步、揮手和思考，選單可獨立關閉待機活動，任務提示優先。程式更新與素材重新匯入分別處理。
