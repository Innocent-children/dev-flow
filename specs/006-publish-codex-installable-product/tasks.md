...
- [ ] T001 Record the exact merged Feature 003/005 commits, Core fixture digest, Codex compatibility range, and intended release version in `specs/006-publish-codex-installable-product/research.md`.
