...
- **FR-012**: The repository MUST contain one `VERSION` file with initial value `0.1.0`.
...
- **FR-020**: Spec Kit managed files under `.agents/skills/`, `.specify/scripts/`, and
  `.specify/templates/` MUST be generated by the pinned Spec Kit release rather than handwritten.
