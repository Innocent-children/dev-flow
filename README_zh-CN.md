...
安装 TaskBelay 后，按 [Codex](packages/codex/README.md)、[DeepSeek](packages/deepseek/README.md)、[Claude Code](docs/CLAUDE.md) 或 [ZCode](docs/ZCODE.md) 指南启用对应 Host。安装包面向 Windows x64 和 macOS arm64；macOS ZCode 实机验证仍待完成。
