...
**작업 경험 축적:** 이해 확인 단계에 들어갈 때마다 작업 AI가 기존 작업을 자동으로 되짚어 보고, 유용한 내용을 소수 저장한 뒤 이유와 적용 조건, 다음에 확인할 사항을 설명합니다. 기록할 가치가 있는 내용이 없으면 생략하고, 다시 이해 확인에 들어오면 기존 기록을 갱신합니다. 사용자의 명시적인 이해 확인은 여전히 필요합니다. 완료하면 워크트리 외부에 Markdown을 내보냅니다. WebUI에서 나중에 읽고, 프로젝트와 키워드로 검색하고, 이해한 내용을 추가하거나 내보내기를 재시도할 수 있습니다. [작업 경험](docs/EXPERIENCES_en.md)을 참고하세요.
