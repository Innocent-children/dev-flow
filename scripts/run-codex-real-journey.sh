...
usage() {
  printf '%s\n' \
    ...
    '   or: run-codex-real-journey.sh --final-local --artifact ABS.tgz --artifact-sha256 SHA256 --artifact-size BYTES --source-commit COMMIT --codex-executable ABS --workspace ABS --result-directory ABS --native-attempt 2 --authorization explicit_user_authorization' \
