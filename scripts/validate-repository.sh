...
const deepseekFinalStagingFiles = [
  ...
  "skills/dev-flow/references/connection-examples.md",
  "skills/dev-flow/references/connection.md",
  "skills/dev-flow/references/core-lifecycle-examples.md",
  "skills/dev-flow/references/core-lifecycle.md",
  "skills/dev-flow/references/nodes/comprehension-examples.md",
  "skills/dev-flow/references/nodes/delivery-examples.md",
  "skills/dev-flow/references/nodes/design-examples.md",
  "skills/dev-flow/references/nodes/implementation-examples.md",
  "skills/dev-flow/references/nodes/refactor-examples.md",
  "skills/dev-flow/references/nodes/requirements-examples.md",
  "skills/dev-flow/references/nodes/tasks-examples.md",
  "skills/dev-flow/references/nodes/test-examples.md",
  "skills/dev-flow/references/recovery-examples.md",
  "skills/dev-flow/references/recovery.md",
  "skills/dev-flow/references/response-examples.md",
