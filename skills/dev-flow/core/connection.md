...
`method_profiles`, `tools`, and `host_preferences.{{host}}.codebase_memory`. Require product `dev-flow`,
canonical version, stdio/ready, {{host}} support, one supported `standard-development` process with a
