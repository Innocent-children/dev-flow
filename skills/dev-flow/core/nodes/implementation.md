...
[Complete request, successful response and error example](implementation-examples.md#dev_flow_submit_implementation-implementation_ready_for_test).
...
[Complete request, successful response and error example](implementation-examples.md#dev_flow_submit_implementation-implementation_requires_design).
...
[Complete request, successful response and error example](implementation-examples.md#dev_flow_submit_implementation-implementation_requires_requirements).
...
[Complete request, successful response and error example](implementation-examples.md#dev_flow_submit_implementation-implementation_needs_refactor).
