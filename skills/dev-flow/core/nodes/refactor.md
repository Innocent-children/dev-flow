...
[Complete request, successful response and error example](refactor-examples.md#dev_flow_submit_refactor-refactor_ready_for_test).
...
[Complete request, successful response and error example](refactor-examples.md#dev_flow_submit_refactor-refactor_requires_design).
...
[Complete request, successful response and error example](refactor-examples.md#dev_flow_submit_refactor-refactor_requires_requirements).
